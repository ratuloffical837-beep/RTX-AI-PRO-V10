      ...
      <div style={{ ...s.card, marginBottom: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
          <div style={{ ...s.numCard, borderColor: '#e2136e55' }} onClick={() => copyNum(BKASH_NUMBER, 'bkash')}>
            ...
            <div style={{ fontSize: 14, fontWeight: 800, color: '#e0e0e0', letterSpacing: '0.05em' }}>{BKASH_NUMBER}</div>
          ...
          <div style={{ ...s.numCard, borderColor: '#f7941d55' }} onClick={() => copyNum(NAGAD_NUMBER, 'nagad')}>
            ...
            <div style={{ fontSize: 14, fontWeight: 800, color: '#e0e0e0', letterSpacing: '0.05em' }}>{NAGAD_NUMBER}</div>
